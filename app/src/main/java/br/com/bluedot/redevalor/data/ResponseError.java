package br.com.bluedot.redevalor.data;
...
//        error.setText("\uD83E\uDD15\n Ops! Tivemos um problema.\nLigue *8486 de um celular Vivo ou 1058 de qualquer outro telefone. que a gente te ajuda! ;)");
        return error;
    }
    ...
    public static ResponseError getUpdateApplicationError() {
        ...
        error.setText("A versão do seu aplicativo está desatualizada. Clique no botão abaixo para atualizar.");
        return error;
    }
